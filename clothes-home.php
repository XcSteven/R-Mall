	...
	<body>
		...
		<div class="main" style="overflow-x: hidden">
			...
			<div class="list">
				...
				<div class="column">
					<div class="card-box">
						<a href="clothes-pdetail-2.html"><img src="images/new10.jpg" alt="Coca-Cola" style="max-width:100%; height: auto"></a>
		...
		<hr>
		<footer class="footer">
			<p>© 2021 - 2021 https://xcsteven.github.io/WPasm1/clothes-home.html - All Rights Reserved.</p>	
